...
#+HTML_LINK_HOME: https://www.google.com
#+HTML_LINK_UP: https://www.bing.com
...
# | *Documentation* | https://refcard-org-mode.readthedocs.org/            |
...
Reading through all the [[https://orgmode.org/org.pdf][documentation]] is highly recommended, but for the truly
...
# See https://asciidoctor.org/docs/user-manual/#the-big-picture

# See https://home.fnal.gov/~neilsen/notebook/orgExamples/org-examples.html.
...
#+begin_src org
See https://www.pirilampo.org (automatic!) and the
[[https://orgmode.org/][Org mode Web site]].
#+end_src
...
#+begin_src org
Clicking on the image [[https://orgmode.org/][file:images/org-mode-unicorn.png]]
...
#+begin_src org
,#+begin_seealso
- [[https://en.wikipedia.org/wiki/Apple][Apples]] ::
     A kind of [[https://en.wikipedia.org/wiki/Fruit][fruit]].
,#+end_seealso
#+end_src

** Todo admonition

# See example at https://docs.ckan.org/en/latest/contributing/python.html
# or https://wsgiservice.readthedocs.org/en/latest/todo.html
...
Yes.  And chekout https://www.doodle.com/ for rescheduling the meeting.
...
# See https://sphinxcontrib-emacs.readthedocs.org/en/latest/guide/domain.html
...
#+html:   <img src="https://img.shields.io/:license-gpl-blue.svg" alt=":license-gpl-blue.svg" />
#+html: </a>
